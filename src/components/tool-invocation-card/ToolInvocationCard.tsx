...
export function ToolInvocationCard({
  ...
  return (
    <Card className="p-4 my-3 w-full max-w-[500px] rounded-md bg-slate-100 dark:bg-zinc-800 border-2 border-slate-200 dark:border-zinc-700 overflow-hidden">
      <button
        type="button"
      ...
      >
        <div
          className={`${needsConfirmation ? "bg-emerald-500/10" : "bg-emerald-500/5"} p-1.5 rounded-full flex-shrink-0`}
        >
          <Gear size={16} className="text-emerald-500" />
        </div>
